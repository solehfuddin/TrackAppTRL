...
public class Adapter_special_item extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Adapter_special_item(Context context, List<Data_fragment_bestproduct> item, RecyclerViewOnClickListener itemClick, String TAG) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == IS_LAST)
        {
            view = LayoutInflater.from(context).inflate(R.layout.see_more, parent, false);
            return new MoreViewHolder(view);
        }
        else
        {
            view = LayoutInflater.from(context).inflate(R.layout.special_item_product, parent, false);
            return new SpesialViewHolder(view);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        {
            ((MoreViewHolder) holder).setData(item.get(position));
        }
        else
        {
            ((SpesialViewHolder) holder).setData(item.get(position));
        }
    }
