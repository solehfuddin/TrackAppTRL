...
public class Adapter_other_product extends RecyclerView.Adapter<Adapter_other_product.ViewHolder> {
    private Context context;
    private List<Data_fragment_bestproduct> item;
    private RecyclerViewOnClickListener itemClick;
    String TAG;

    public Adapter_other_product(Context context, List<Data_fragment_bestproduct> item, RecyclerViewOnClickListener itemClick, String TAG) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.other_item_product, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            imgProduct = itemView.findViewById(R.id.other_item_imgproduct);
            txtId = itemView.findViewById(R.id.other_item_txtidproduct);
            txtDisc = itemView.findViewById(R.id.other_item_txtdiscproduct);
            txtBrandName = itemView.findViewById(R.id.other_item_txtbrandproduct);
            txtProductName = itemView.findViewById(R.id.other_item_txtnameproduct);
            txtPrice = itemView.findViewById(R.id.other_item_txtpriceproduct);
