...
//        this.buttonText = buttonText;
        ...
        downloadFileName = downloadUrl.replace("http://180.250.96.154/trl-webs/assets/template/", "");
...
//            buttonText.setText("starting");//Set Button Text when download started
        }
...
//                    buttonText.setText("failed");//If download failed change button text
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
//                            buttonText.setEnabled(true);
//                            buttonText.setText("retry");//Change button text again after 3sec
                        }
                    }, 3000);
